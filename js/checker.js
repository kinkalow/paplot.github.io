mut_checker = (function () {
  ...
  p.bar_sort = function () {
    ...
    for (var idx = 0; idx < this.dataset.length; idx++) {
      this.svg_obj
        ...
        .selectAll("rect")
        .attr("x", function (d, i) {
          return p.xy_position(
            that.axis.x.asc,
            that.plot.w,
            that.padding.left,
            x_items,
            p.pos_from_sort_list(that.axis.x.sort_list, that.dataset[idx].keys[i], -1),
            0
          );
        })
        .attr("y", function (d, i) {
          return p.xy_position(
            ...
            that.padding.top,
            y_items,
            p.pos_from_sort_list(that.axis.y.sort_list, that.dataset[idx].keys2[i], -1),
            0
          );
        });
    }
    ...
    this.svg_obj
      ...
      .attr("x", function (d, i) {
        return p.xy_position(
          ...
          that.padding.left,
          x_items,
          p.pos_from_sort_list(that.axis.x.sort_list, d, -1),
          0
        );
      })
    ...
    this.svg_obj
      ...
      .attr("y", function (d, i) {
        return p.xy_position(
          ...
          that.padding.top,
          y_items,
          p.pos_from_sort_list(that.axis.y.sort_list, d, -1),
          0
        );
      });
    ...
    this.svg_obj
      ...
      .attr("x", function (d, i) {
        return p.xy_position(
          ...
          that.padding.left,
          x_items,
          p.pos_from_sort_list(that.axis.x.sort_list, d[0], -1),
          0
        );
      })
      .attr("y", function (d, i) {
        return p.xy_position(
          ...
          that.padding.top,
          y_items,
          p.pos_from_sort_list(that.axis.y.sort_list, d[1], -1),
          0
        );
      });
          ...
          if (that.options.grids[idx].orient == "bottom") {
            tx =
              ...
              p.xy_position(
                ...
                that.padding.left,
                x_items,
                p.pos_from_sort_list(that.axis.x.sort_list, classes[1], i),
                Math.floor(that.plot.w / x_items / 2)
              );
          ...
          if (that.options.grids[idx].orient == "left") {
            ...
            ty =
              ...
              p.xy_position(
                ...
                that.padding.top,
                y_items,
                p.pos_from_sort_list(that.axis.y.sort_list, classes[1], i),
                Math.floor(that.plot.h / y_items / 2)
              );
  ...
  p.resize = function () {
    ...
    this.svg_obj.selectAll("g.transparent_bar1").selectAll("rect").attr("height", this.plot.h).attr("width", width);

    var height = this.plot.h / this.y_items() - this.bar_padding(this.plot.h, this.y_items(), this.options.bar_padding_y);

    this.svg_obj.selectAll("g.transparent_bar2").selectAll("rect").attr("height", height).attr("width", this.plot.w);

    // transparent-rect
    this.svg_obj.selectAll("g.transparent_rect").selectAll("rect").attr("height", height).attr("width", width);
    ...
    var frame_pos = [
      ...
      { x1: this.padding.left, y1: this.padding.top, x2: this.padding.left, y2: this.padding.top + this.plot.h },
      {
        ...
        y1: this.padding.top + this.plot.h,
        x2: this.padding.left + this.plot.w,
        y2: this.padding.top + this.plot.h,
      },
      {
        x1: this.padding.left + this.plot.w,
        y1: this.padding.top,
        x2: this.padding.left + this.plot.w,
        y2: this.padding.top + this.plot.h,
      },
    ...
    this.svg_obj
      ...
      .attr("x1", function (d, i) {
        return frame_pos[i].x1;
      })
      .attr("x2", function (d, i) {
        return frame_pos[i].x2;
      })
      .attr("y1", function (d, i) {
        return frame_pos[i].y1;
      })
      .attr("y2", function (d, i) {
        return frame_pos[i].y2;
      });
  ...
  p.update = function () {
    ...
    for (idx = 0; idx < 2; idx++) {
      this.svg_obj
        .selectAll("g.transparent_bar" + (idx + 1))
        .selectAll("rect")
        .remove();
    ...
    this.svg_obj.selectAll("g.transparent_rect").selectAll("rect").remove();
    ...
    this.svg_obj
      ...
      .on("click", function (d, i) {
        ...
        var on1 = that.svg_obj
          .selectAll("g.transparent_bar1")
          .select("rect." + d[0])
          .classed(key1);
        var on2 = that.svg_obj
          .selectAll("g.transparent_bar2")
          .select("rect." + d[1])
          .classed(key2);
    ...
    this.svg_obj.selectAll("g.label").selectAll("text").remove();
    ...
    this.svg_obj.selectAll("g.grid").selectAll("line").remove();
  ...
  p.init = function () {
    ...
    // transparent-bar
    this.svg_obj.append("g").attr("class", "transparent_bar1").selectAll("rect").data([]).enter();

    this.svg_obj.append("g").attr("class", "transparent_bar2").selectAll("rect").data([]).enter();

    // transparent-rect
    this.svg_obj.append("g").attr("class", "transparent_rect").selectAll("rect").data([]).enter();
    ...
    // axis
    this.svg_obj.append("g").attr("class", "label").selectAll("line").data([]).enter();

    this.svg_obj.append("g").attr("class", "grid").selectAll("line").data([]).enter();
  ...
  p.reset_select = function () {
    this.svg_obj.selectAll("g.transparent_bar1").selectAll("rect").style("opacity", 0);
    this.svg_obj.selectAll("g.transparent_bar2").selectAll("rect").style("opacity", 0);
  };
  // -----------------------------------
  // over-ride
  // -----------------------------------
