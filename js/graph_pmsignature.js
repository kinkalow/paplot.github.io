(function () {
  ...
  function update_div() {
    ...
    var max_width =
      Number(d3.select("div.container").style("width").replace("px", "")) -
  ...
  msig_draw.init = function () {
    ...
    if (div_integral != 0) {
      ...
      // list box
      {
        ...
        d3.select("#chart_mode").on("change", function () {
  ...
  function set_sort_listbox(mode) {
    ...
    d3.select("#chart_sort").selectAll("option").remove();
    ...
    d3.select("#chart_sort").on("change", function () {
      if (this[0].selected == true) {
        sort(["sample_ID"], [true]);
      } else {
  ...
  function draw_pmsignature(name, signature_id) {
    ...
    // Alt
    {
      ...
      div_pm1.signature_rects[0].options.colorset = [
        msig_data.label_colors.A,
        msig_data.label_colors.C,
        msig_data.label_colors.G,
        msig_data.label_colors.T,
        msig_data.label_colors.A,
        msig_data.label_colors.C,
        msig_data.label_colors.G,
        msig_data.label_colors.T,
    ...
    for (var i = 0; i < msig_data.dataset_ref[signature_id].length; i++) {
      ...
      div_pm1.signature_rects[i + 1].options.colorset = [
        msig_data.label_colors.A,
        msig_data.label_colors.C,
        msig_data.label_colors.G,
        msig_data.label_colors.T,
